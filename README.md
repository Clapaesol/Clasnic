...
```
Clasnic/
├── .github/      # Configuración de GitHub (plantillas de issues/PRs, workflows)
├── docs/         # Documentación del proyecto (visión, requisitos, arquitectura...)
├── assets/       # Recursos gráficos
├── backend/      # API y lógica de negocio (pendiente)
├── frontend/     # Interfaz de usuario (pendiente)
├── database/     # Modelos y migraciones de base de datos (pendiente)
├── docker/       # Configuración de contenedorización (pendiente)
